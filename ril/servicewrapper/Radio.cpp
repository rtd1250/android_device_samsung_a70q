...
Return<void> Radio::supplyIccPinForApp(int32_t serial, const hidl_string& pin, const hidl_string& aid) {
    getSecIRadio()->supplyIccPinForApp(serial, pin, aid);
    return Void();
}

Return<void> Radio::supplyIccPukForApp(int32_t serial, const hidl_string& puk, const hidl_string& pin, const hidl_string& aid) {
    getSecIRadio()->supplyIccPukForApp(serial, puk, pin, aid);
    return Void();
}

Return<void> Radio::supplyIccPin2ForApp(int32_t serial, const hidl_string& pin2, const hidl_string& aid) {
    getSecIRadio()->supplyIccPin2ForApp(serial, pin2, aid);
    return Void();
}

Return<void> Radio::supplyIccPuk2ForApp(int32_t serial, const hidl_string& puk2, const hidl_string& pin2, const hidl_string& aid) {
    getSecIRadio()->supplyIccPuk2ForApp(serial, puk2, pin2, aid);
    return Void();
}

Return<void> Radio::changeIccPinForApp(int32_t serial, const hidl_string& oldPin, const hidl_string& newPin, const hidl_string& aid) {
    getSecIRadio()->changeIccPinForApp(serial, oldPin, newPin, aid);
    return Void();
}

Return<void> Radio::changeIccPin2ForApp(int32_t serial, const hidl_string& oldPin2, const hidl_string& newPin2, const hidl_string& aid) {
...
Return<void> Radio::getFacilityLockForApp(int32_t serial, const hidl_string& facility, const hidl_string& password, int32_t serviceClass, const hidl_string& appId) {
    getSecIRadio()->getFacilityLockForApp(serial, facility, password, serviceClass, appId);
    return Void();
}

Return<void> Radio::setFacilityLockForApp(int32_t serial, const hidl_string& facility, bool lockState, const hidl_string& password, int32_t serviceClass, const hidl_string& appId) {
    getSecIRadio()->setFacilityLockForApp(serial, facility, lockState, password, serviceClass, appId);
    return Void();
}

Return<void> Radio::setBarringPassword(int32_t serial, const hidl_string& facility, const hidl_string& oldPassword, const hidl_string& newPassword) {
...
Return<void> Radio::setNetworkSelectionModeManual(int32_t serial, const hidl_string& operatorNumeric) {
...
Return<void> Radio::acknowledgeIncomingGsmSmsWithPdu(int32_t serial, bool success, const hidl_string& ackPdu) {
...
Return<void> Radio::requestIccSimAuthentication(int32_t serial, int32_t authContext, const hidl_string& authData, const hidl_string& aid) {
