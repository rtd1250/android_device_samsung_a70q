...
struct SecRadioResponse : public IRadioResponse {
    ...
    Return<void> secGetIccCardStatusReponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::vendor::samsung::hardware::radio::V1_2::SecCardStatus& cardStatus) override;
    Return<void> secSupplyNetworkDepersonalizationResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, int32_t remainingRetries) override;
    Return<void> secAcceptCallResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> secDialResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> secGetCurrentCallsResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const hidl_vec<::vendor::samsung::hardware::radio::V1_2::SecCall>& calls) override;
    Return<void> secGetSignalStrengthResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::vendor::samsung::hardware::radio::V1_2::SecSignalStrength& sigStrength) override;
    Return<void> secGetVoiceRegistrationStateResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::vendor::samsung::hardware::radio::V1_2::SecVoiceRegStateResult& voiceRegResponse) override;
    Return<void> secGetDataRegistrationStateResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::vendor::samsung::hardware::radio::V1_2::SecDataRegStateResult& dataRegResponse) override;
    Return<void> secExplicitCallTransferResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> secGetOperatorRespnse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const hidl_string& longName, const hidl_string& shortName, const hidl_string& plmn, const hidl_string& epdgname) override;
    Return<void> oemSetBarringPasswordResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> secgetImsRegistrationStateReponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const hidl_vec<int32_t>& regState) override;
    Return<void> secGetAvailableNetworkResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const hidl_vec<::vendor::samsung::hardware::radio::V1_2::SecOperatorInfo>& networkInfo) override;
    Return<void> oemDialEmergencyCallResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> oemCallDeflectionResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> oemModifyCallInitiateResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::android::hardware::radio::V1_0::LastCallFailCauseInfo& failCauseInfo) override;
    Return<void> oemSetImsCallListResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> oemGetPreferredNetworkListResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const hidl_vec<::vendor::samsung::hardware::radio::V1_2::OemPreferredNetworkInfo>& infos) override;
    Return<void> oemSetPreferredNetworkListResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> oemSendEncodedUSSDResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> oemHoldCallResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> oemGetDisable2gResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, int32_t isDisable) override;
    Return<void> oemSetDisable2gResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> oenGetAcbInfoResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const hidl_vec<int32_t>& acbInfo) override;
    Return<void> oemSetTransferCallResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> oemGetICBarringResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const hidl_string& numberDateList) override;
    Return<void> oemSetICBarringResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> oemQueryCnapResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, int32_t queryCNAP) override;
    Return<void> oemRefreshNitzTimeResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> oemEnableUnsolResponseResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> oemCancelTransferCallResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> oemAcknowledgeRilConnectedResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> oemGetPhoneBookStorageInfoResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const hidl_vec<int32_t>& phoneBookInfo) override;
    Return<void> oemUsimPbCapaResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const hidl_vec<int32_t>& usimPbCapa) override;
    Return<void> oemSetSimPowerResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, int32_t power) override;
    Return<void> oemSetSimOnOffResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> oemSetSimInitEventResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> oemGetSimLockInfoResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const hidl_vec<int32_t>& simLockInfO) override;
    Return<void> oemSupplyIccPersoResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> oemChangeIccPersoResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> oemGetPhoneBookEntryResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::vendor::samsung::hardware::radio::V1_2::OemSimPBResponse& SimPBResponseInfo) override;
    Return<void> oemAccessPhoneBookEntryResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, int32_t SimPbAccessResp) override;
    Return<void> oemGetCellBroadcastConfigResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::vendor::samsung::hardware::radio::V1_2::OemCbConfigArgs& configs) override;
    Return<void> oemEmergencySearchResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, int32_t respEmergencySearch) override;
    Return<void> oemEmergencyControlResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> oemGetAtrResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const hidl_string& atr) override;
    Return<void> oemSendCdmaSmsExpectMoreResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::vendor::samsung::hardware::radio::V1_2::SecSendSmsResult& sms) override;
    Return<void> secSendSmsResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::vendor::samsung::hardware::radio::V1_2::SecSendSmsResult& sms) override;
    Return<void> secSendSMSExpectMoreResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::vendor::samsung::hardware::radio::V1_2::SecSendSmsResult& sms) override;
    Return<void> secSendCdmaSmsResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::vendor::samsung::hardware::radio::V1_2::SecSendSmsResult& sms) override;
    Return<void> secSendImsSmsResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::vendor::samsung::hardware::radio::V1_2::SecSendSmsResult& sms) override;
    Return<void> secSetDataAllowedResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> secGetCdmaRoamingPreferenceResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, int32_t n, int32_t m) override;
    Return<void> secEnable5gResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> secDisable5gResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> secQuery5gStatusResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
    Return<void> secQueryNrDcParamResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::vendor::samsung::hardware::radio::V1_2::DcParam& endcDcnr) override;
    Return<void> secQueryNrBearerAllocationResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, int32_t bearerStatus) override;
    Return<void> secQueryNrSignalStrengthResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::vendor::samsung::hardware::radio::V1_2::NrSignalStrength& nrSignalStrength) override;
    Return<void> oemQueryCsgListResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const hidl_vec<::vendor::samsung::hardware::radio::V1_2::OemCsgInfo>& csgInfos) override;
    Return<void> oemSelectCsgManualResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info) override;
